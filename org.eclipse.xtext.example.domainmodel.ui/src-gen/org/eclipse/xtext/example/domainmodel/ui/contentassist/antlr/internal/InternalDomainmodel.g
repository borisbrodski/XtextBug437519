...
:
(
{ before(grammarAccess.getOperationAccess().getTypeJvmTypeReferenceParserRuleCall_6_1_0()); }
	ruleJvmTypeReference{ after(grammarAccess.getOperationAccess().getTypeJvmTypeReferenceParserRuleCall_6_1_0()); }
)
