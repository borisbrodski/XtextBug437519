...
public class DomainmodelGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class OperationElements extends AbstractParserRuleElementFinder {
		...
		//Operation:
		//	annotations+=XAnnotation* "op" name=ValidID "(" (params+=FullJvmFormalParameter (","
		//	params+=FullJvmFormalParameter)*)? ")" (":" type=JvmTypeReference)? body=XBlockExpression;
		public ParserRule getRule() { return rule; }

		//annotations+=XAnnotation* "op" name=ValidID "(" (params+=FullJvmFormalParameter ("," params+=FullJvmFormalParameter)*)?
